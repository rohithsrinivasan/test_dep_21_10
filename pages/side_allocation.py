...
if 'grouped_pin_table' in st.session_state:
    ...
    changing_as_per_style_guide = st.checkbox("Dual-in-line with Last Pin to Bottom right")
    ...
    if changing_as_per_style_guide:
        ...
        #if isinstance(added_empty_new_grouping_column, pd.DataFrame):
        #    st.dataframe(added_empty_new_grouping_column)  # Display single DataFrame
        #elif isinstance(added_empty_new_grouping_column, dict):
        #    for key, df in added_empty_new_grouping_column.items():
