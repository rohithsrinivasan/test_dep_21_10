...
def header_intro():
    ...
    with col1:
        st.header('SymbolGen')
        st.text('version 1.1 - Last update 14/10/2024')
    with col3:
        st.image('dados/logo.png', width=250 )
    
def header_intro_2():
    st.write("This application's main functionality is to generator ECAD Symbol from Standardised Datasheets and generate the downloadable ")
